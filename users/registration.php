...
require_once '../config/brevo_helper.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($organization_id)) {
    ...
    foreach ($form_fields as $field) {
        ...
        if ($column == 'govt_id_link')
            continue; // Skip file upload for now
    ...
    if ($stmt_insert->execute()) {
        ...
        if (!empty($valid_data['email'])) {
            $emailResult = sendRegistrationConfirmationEmail(
                $valid_data['email'],
                $valid_data['name'] ?? 'Guest',
                $qr_code_link,
                $org_title,
                $nav_bg_color,
                $logo_url
            );
            // Log result but don't block registration on email failure
            if (!$emailResult['success']) {
                error_log("Registration email failed for {$valid_data['email']}: " . $emailResult['message']);
            }
        }
        // +++ END EMAIL SENDING +++
...
<style>
    .hero-background-video {
        ...
        /* Sits behind content */
        overflow: hidden;
        /* Hides any part of the video spilling out */
        background-attachment: fixed !important;
        /* This keeps the image still (parallax) */
    }
    ...
    .hero-section {
        ...
        position: relative;
        overflow: hidden;
        /* This contains the blurred edges of the image */
    }
    ...
    .hero-content {
        position: relative;
        z-index: 3;
        /* This puts your text on top of the overlay */
        color: white;
        text-align: center;
        padding: 5rem 1.5rem;
        /* This gives the hero section its size */
    ...
    .registration-form-container {
        ...
        /* Pulls it up, adds bottom margin */
        padding: 1.5rem 1rem;
        /* Increased padding */
    ...
    .form-select:focus {
        ...
        box-shadow: none;
        /* Removes the default Bootstrap glow */
        background-color:
            <?php echo $nav_bg_color . '1A'; ?>
        ;
...
<main>
            ...
            <form id="registrationForm" novalidate enctype="multipart/form-data">
                <div class="row g-3">
                    <?php foreach ($form_fields as $field):
                        ...
                        // Display "Full Name" instead of "Name"
                        if ($field_name === 'name') {
                            $label = 'Full Name';
                        }
                        ?>
                        <div class="col-12">
                            <label for="<?php echo $field_name; ?>" class="form-label"><?php echo $label; ?> <span
                            ...
                            <?php else: // +++ ALL OTHER FIELDS (OLD LOGIC) +++
                                            ...
                                            ?>
                                <input type="<?php echo $input_type; ?>" class="form-control" id="<?php echo $field_name; ?>"
                                    name="<?php echo $field_name; ?>" required>
                                <div class="invalid-feedback">
    ...
    <div id="successCard" class="registration-form-container text-center d-none">
        <div class="card-body">
            ...
            <p>You can now access your event details, including your personal QR code and ticket information, from the
                navigation menu.</p>
            <hr class="my-4">
